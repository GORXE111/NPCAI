...
REF_LP_FILE = os.path.join(DATA_DIR, "ref_logprobs_d3.json")
OUT = os.path.expanduser("~/npcllm/checkpoints/kim_q35_2b_stage3_dpo_d3")

LR = 5e-7
BETA = 0.1    # D3: anchor to warm-start (which already has the new tools)
EPOCHS = 1
GRAD_ACCUM = 8
