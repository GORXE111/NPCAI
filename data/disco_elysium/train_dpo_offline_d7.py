...
# D7: policy-init AND reference are v5.0 (all-tool SFT, emotion non-zero)
STAGE2_LORA = os.path.expanduser("~/npcllm/checkpoints/kim_q35_2b_stage2_v5_0/lora")
DATA_DIR = os.path.expanduser("~/npcllm/data_kim_dpo_d7")
REF_LP_FILE = os.path.join(DATA_DIR, "ref_logprobs_d7.json")
OUT = os.path.expanduser("~/npcllm/checkpoints/kim_q35_2b_stage3_dpo_d7")

LR = 5e-7
BETA = 0.1    # D7: standard KL — v5.0 already has all tools, just reweight
EPOCHS = 1
GRAD_ACCUM = 8
