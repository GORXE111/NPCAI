...
DATA_DIR = os.path.expanduser("~/npcllm/data_kim_dpo_d5")
REF_LP_FILE = os.path.join(DATA_DIR, "ref_logprobs_d5.json")
OUT = os.path.expanduser("~/npcllm/checkpoints/kim_q35_2b_stage3_dpo_d5")

LR = 5e-7
BETA = 0.05   # D5: looser KL lets recall pairs lift under-called categories
EPOCHS = 1
GRAD_ACCUM = 8
