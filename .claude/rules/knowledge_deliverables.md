...
| ID | 产出 | 状态 | 备注 |
|----|------|:----:|------|
| **L1** | `kim-q35-08b-stage1.lora` | 🟡 训练中 | 1,587 Kim 样本，r=16 dropout=0.15 |
| **L2** | `kim-q35-08b-stage2.lora` | ⚪ 待做 | 从 `[Action/Check]` 提取的工具数据 |
...
| ID | 产出 | 状态 |
|----|------|:----:|
| **L4** | `kim_train.jsonl` (1,587 SFT) | ✅ 完成 |
